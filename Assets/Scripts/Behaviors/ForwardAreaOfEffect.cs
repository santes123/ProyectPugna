...
public class ForwardAreaOfEffect : AreaOfEffect
{
    ...
    public override List<T> GetTargets<T>() {
        ...
        RaycastHit[] hits = Physics.RaycastAll(transform.position, transform.forward, radius, layerMask, (shouldHitTriggers ? QueryTriggerInteraction.Collide : QueryTriggerInteraction.Ignore));
