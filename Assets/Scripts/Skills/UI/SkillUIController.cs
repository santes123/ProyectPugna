...
public class SkillUIController : MonoBehaviour
{
    ...
    public void GameModeChange()
    {
        ...
        //controlamos las skill como dash y push away que siempre tienen que mostrarse
        ...
        {
           //gestionamos para que el boomerang, attactAndThrow y PsychicShot siempre se muestren
           if (skill.tecla == KeyCode.Z || skill.tecla == KeyCode.Q)
            {
                HideSKill();
                
            }
            else if (gamemode == GameMode.Boomerang || gamemode == GameMode.AttractThrow || gamemode == GameMode.PyshicShot)
            {
                Deselect();
                ShowSkill();
